...
template <typename T>
void safeCudaMemcpy2Device_macro(T* __restrict__ dst, const T* __restrict__ src, size_t size, int line, const char* file){
...
template <typename T>
void safeCudaMemcpy2Host_macro(T* __restrict__ dst, const T* __restrict__ src, size_t size, int line, const char* file){
